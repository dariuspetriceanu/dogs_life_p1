...
public class DogsHandlerTest
{
    ...
    public  void    add_a_dog_return_number_of_dogs_in_repo_is_one()
    {
        ...
        Mockito.when(itsDogsRepo.save(theDog)).thenReturn(theDog.getId());
    ...
    public  void    add_dog_and_remove_dog_return_number_of_dogs_is_zero()
    {
        ...
        theDog.setName("Bruno");
        Mockito.when(itsDogsRepo.save(theDog)).thenReturn(theDog.getId());
        long uniqueDog = cut.addDog( theDog );
    ...
    public  void    find_dog_by_valid_id_returns_one_dog()
    {
        ...
        long jpaDog = addedDog;
        Optional<Long> opt = Optional.of(addedDog);
...
//        DogHandler cut = new DogHandler();
    ...
    public  void    update_dog_that_exists_returns_dog_id()
    {
        ...
        theDog.setName("Frank");
        Mockito.when(itsDogsRepo.save(theDog)).thenReturn(theDog.getId());
        long expectedDog = cut.addDog( theDog );
        Dog dogToUpdate = theDog;
        String dogToFind = "Frank";
        theDog = new Dog();
        theDog.setName("Penny");
        cut.addDog( theDog );
        Mockito.when(itsDogsRepo.save(dogToUpdate)).thenReturn(dogToUpdate.getId());
